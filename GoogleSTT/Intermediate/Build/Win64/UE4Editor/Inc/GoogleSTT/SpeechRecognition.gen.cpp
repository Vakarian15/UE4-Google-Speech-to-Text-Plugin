...
#include "GoogleSTT/Public/SpeechRecognition.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	GOOGLESTT_API UClass* Z_Construct_UClass_USpeechRecognition_NoRegister();
	GOOGLESTT_API UClass* Z_Construct_UClass_USpeechRecognition();
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_GoogleSTT_Model_Hash() { return 3986337707U; }
	...
	uint32 Get_Z_Construct_UEnum_GoogleSTT_Language_Hash() { return 2129357164U; }
...
static struct FScriptStruct_GoogleSTT_StaticRegisterNativesFGoogleSTTConfig
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FGoogleSTTConfig_Hash() { return 1116835680U; }
	DEFINE_FUNCTION(USpeechRecognition::execGoogleSTT)
	{
		P_GET_STRUCT(FGoogleSTTConfig,Z_Param_config);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(USpeechRecognition**)Z_Param__Result=USpeechRecognition::GoogleSTT(Z_Param_config);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(USpeechRecognition::execSetApiKey)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ApiKey);
		P_FINISH;
		P_NATIVE_BEGIN;
		USpeechRecognition::SetApiKey(Z_Param_ApiKey);
		P_NATIVE_END;
	}
	void USpeechRecognition::StaticRegisterNativesUSpeechRecognition()
	{
		UClass* Class = USpeechRecognition::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "GoogleSTT", &USpeechRecognition::execGoogleSTT },
			{ "SetApiKey", &USpeechRecognition::execSetApiKey },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics
	{
		struct SpeechRecognition_eventGoogleSTT_Parms
		{
			FGoogleSTTConfig config;
			USpeechRecognition* ReturnValue;
		};
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpeechRecognition_eventGoogleSTT_Parms, ReturnValue), Z_Construct_UClass_USpeechRecognition_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::NewProp_config = { "config", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpeechRecognition_eventGoogleSTT_Parms, config), Z_Construct_UScriptStruct_FGoogleSTTConfig, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::NewProp_config,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::Function_MetaDataParams[] = {
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USpeechRecognition, nullptr, "GoogleSTT", nullptr, nullptr, sizeof(SpeechRecognition_eventGoogleSTT_Parms), Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USpeechRecognition_GoogleSTT()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USpeechRecognition_GoogleSTT_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics
	{
		struct SpeechRecognition_eventSetApiKey_Parms
		{
			FString ApiKey;
		};
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::NewProp_ApiKey = { "ApiKey", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpeechRecognition_eventSetApiKey_Parms, ApiKey), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::NewProp_ApiKey,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::Function_MetaDataParams[] = {
		{ "Category", "GoogleSTT" },
		{ "ModuleRelativePath", "Public/SpeechRecognition.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USpeechRecognition, nullptr, "SetApiKey", nullptr, nullptr, sizeof(SpeechRecognition_eventSetApiKey_Parms), Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USpeechRecognition_SetApiKey()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USpeechRecognition_SetApiKey_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	UClass* Z_Construct_UClass_USpeechRecognition_NoRegister()
	{
		return USpeechRecognition::StaticClass();
	}
	struct Z_Construct_UClass_USpeechRecognition_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_USpeechRecognition_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UBlueprintAsyncActionBase,
		(UObject* (*)())Z_Construct_UPackage__Script_GoogleSTT,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_USpeechRecognition_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USpeechRecognition_GoogleSTT, "GoogleSTT" }, // 1413517349
		{ &Z_Construct_UFunction_USpeechRecognition_SetApiKey, "SetApiKey" }, // 2508629920
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USpeechRecognition_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "SpeechRecognition.h" },
		{ "ModuleRelativePath", "Public/SpeechRecognition.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USpeechRecognition_Statics::NewProp_Finish_MetaData[] = {
		{ "ModuleRelativePath", "Public/SpeechRecognition.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USpeechRecognition_Statics::NewProp_Finish = { "Finish", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpeechRecognition, Finish), Z_Construct_UDelegateFunction_GoogleSTT_OnFinish__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USpeechRecognition_Statics::NewProp_Finish_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpeechRecognition_Statics::NewProp_Finish_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USpeechRecognition_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USpeechRecognition_Statics::NewProp_Finish,
	};
	const FCppClassTypeInfoStatic Z_Construct_UClass_USpeechRecognition_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<USpeechRecognition>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpeechRecognition_Statics::ClassParams = {
		&USpeechRecognition::StaticClass,
		nullptr,
		&StaticCppClassTypeInfo,
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_USpeechRecognition_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_USpeechRecognition_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USpeechRecognition_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USpeechRecognition_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_USpeechRecognition()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USpeechRecognition_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USpeechRecognition, 887248359);
	template<> GOOGLESTT_API UClass* StaticClass<USpeechRecognition>()
	{
		return USpeechRecognition::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USpeechRecognition(Z_Construct_UClass_USpeechRecognition, &USpeechRecognition::StaticClass, TEXT("/Script/GoogleSTT"), TEXT("USpeechRecognition"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(USpeechRecognition);
