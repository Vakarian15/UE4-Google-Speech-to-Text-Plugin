...
namespace Audio
{
	 ...
	 */
	class FAudioRecManager
	{
	public:
		// Retrieves the singleton recording manager
		static FAudioRecManager& Get();
		...
		void StartRecording(const FRecSettings& Settings, TArray<USoundWave*>& OutSoundWaves, int32 SampleRate);
	...
	private:
		...
		int32 WAVE_FILE_SAMPLERATE = 44100;

		// Copy of the input recording settings
		FRecSettings Settings;
