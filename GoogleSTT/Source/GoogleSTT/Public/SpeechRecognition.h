...
UCLASS()
class GOOGLESTT_API USpeechRecognition : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GoogleSTT", meta = (BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject"))
		static USpeechRecognition* GoogleSTT(FGoogleSTTConfig config);

	void Recognize(FGoogleSTTConfig config, USpeechRecognition* BlueprintNode);
